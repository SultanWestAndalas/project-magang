      ...
      <section id="blog" className="relative z-10 px-6 pb-16 md:pb-32 max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              <div key={post.ID} className="glass p-8 rounded-[32px] group hover:border-accent-purple/50 transition-all duration-500 relative flex flex-col h-full overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-accent-purple/5 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-accent-purple/10 transition-all duration-500" />
                ...
                <h3 className="text-2xl font-bold mb-4 group-hover:text-white transition-colors line-clamp-2 relative z-10">
                  {post.Title}
                </h3>
                ...
                <div className="flex items-center justify-between border-t border-white/10 pt-5 mt-auto relative z-10">
                  <span className="text-xs font-medium text-white/70 flex items-center gap-2">
                    <div className="w-5 h-5 rounded-full bg-gradient-to-br from-accent-purple to-accent-magenta flex items-center justify-center text-[10px] text-white font-bold">
